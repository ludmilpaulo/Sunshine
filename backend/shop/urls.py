...
from .analytics_views import sales_by_user, sales_trend_by_user, top_sellers, sales_by_payment_method, sales_by_user_with_tax, product_sales_stock_report, stock_movement_report
...
urlpatterns = [
    ...
    path("analytics/stock-movement-report/", stock_movement_report, name="stock-movement-report"),
